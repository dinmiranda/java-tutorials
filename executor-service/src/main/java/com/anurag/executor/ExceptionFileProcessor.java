...
public class ExceptionFileProcessor implements Callable<Boolean> {
    ...
    public ExceptionFileProcessor(File file, Map<Exception, AtomicInteger> requestExceptionCount) {
        this.file = file;
    ...
    public Boolean call() throws FileNotFoundException {
        ...
        while (sc.hasNext()) {
            ...
            Exception exception = new Exception().setRequestId(currError[0]).setTimeStamp(Long.parseLong(currError[1]))
                    .setType(currError[2]);
